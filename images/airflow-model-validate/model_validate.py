...
def model_validations(model_dir: str, data_dir: str, metric_dir:str):
    ...
    train_accuracy = accuracy_score(train_data['label'], model.predict(train_data.drop(['label'], axis=1)))
    val_accuracy = accuracy_score(valid_data['label'], model.predict(valid_data.drop(['label'], axis=1)))
